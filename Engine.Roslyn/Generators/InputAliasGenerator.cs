        ...
        ctx.RegisterImplementationSourceOutput(
            ...
            static (spc, info) =>
            {
                ...
                spc.AddSource(
                    ...
                    $"""
                      // <auto-generated/>
                      global using OnInput = global::Engine.Core.Input.Attributes.OnInputAttribute<global::{info.fqName}>;
                      global using OnInputHeld = global::Engine.Core.Input.Attributes.OnInputHeldAttribute<global::{info.fqName}>;
                      global using OnInputReleased = global::Engine.Core.Input.Attributes.OnInputReleasedAttribute<global::{info.fqName}>;
                      """);
            });
    }
