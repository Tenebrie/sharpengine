...
namespace Engine.Module.Utility.Instrumentation;
...
public class Profiler : IProfiler
{
    ...
    public int CurrentBufferIndex => Instance._currentBufferIndex;
...
public sealed class ProfilingStopwatch : IProfilingStopwatch
{
...
public class ProfilerEntry : IProfilerEntry
{
    private int _ptr = 0;
