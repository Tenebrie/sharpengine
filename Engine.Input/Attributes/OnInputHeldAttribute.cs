...
public class OnInputHeldAttribute<T>(T? action, Key? explicitKey, double x, double y, double z, InputParamBinding bindingParams)
    : Attribute, IOnInputAttribute where T : struct, Enum
{
    ...
    public OnInputHeldAttribute(Key explicitKey)
        : this(null, explicitKey, 0.0, 0.0, 0.0, InputParamBinding.None) {}
    public OnInputHeldAttribute(Key explicitKey, double value)
        : this(null, explicitKey, value, 0.0, 0.0, InputParamBinding.Double) {}
    public OnInputHeldAttribute(Key explicitKey, double x, double y)
        : this(null, explicitKey, x, y, 0.0, InputParamBinding.Vector2) { }
    public OnInputHeldAttribute(Key explicitKey, double x, double y, double z)
