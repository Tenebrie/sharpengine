...
public class OnKeyInputHeldAttribute(Key explicitKey, double x, double y, double z, InputParamBinding bindingParams) : Attribute, IOnInputHeldAttribute
{
    ...
    public OnKeyInputHeldAttribute(Key explicitKey, double x, double y, double z)
